...
public class Utilidades {
    ...
    public static UUID stringToUUID( String uuid ) {
        ...
        // Log.d( com.example.criborm.cleanairly.MainActivity.ETIQUETA_LOG, " \n\n***** stringToUUID *** " + uuid  + "=?=" + com.example.criborm.cleanairly.Utilidades.uuidToString( res ) );
    ...
    public static int bytesToIntOK( byte[] bytes ) {
        ...
        for( byte b : bytes ) {
           /*
           Log.d( com.example.criborm.cleanairly.MainActivity.ETIQUETA_LOG, "bytesToInt(): byte: hex=" + Integer.toHexString( b )
       ...
       /*
        Log.d( com.example.criborm.cleanairly.MainActivity.ETIQUETA_LOG, "bytesToInt(): res = " + res + " ~res=" + (res ^ 0xffff)
                + "~res=" + ~((byte) res)
        );
        */
