 ...
 * Se encarga de la medición de datos y la comunicación con dispositivos BLE.
 */
public class MainActivity extends AppCompatActivity {
    ...
    public void boton_recibir_pulsado(View quien) {
        ...
        //192.168.1.102
        elPeticionario.hacerPeticionREST("GET", "http://10.237.27.168:1234/medicion", null,
        ...
        public void boton_enviar_pulsado (View quien) {
            ...
            try {
                ...
                elPeticionario.hacerPeticionREST("POST", "http://10.237.27.168:1234/insertarMedicion", cuerpecito ,
                        new PeticionarioREST.RespuestaREST() {
                            @Override
                            public void callback(int codigo, String cuerpo) {
