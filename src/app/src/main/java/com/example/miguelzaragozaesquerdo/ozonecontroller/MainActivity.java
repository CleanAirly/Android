...
import com.example.miguelzaragozaesquerdo.ozonecontroller.PeticionarioREST;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.elTexto = (TextView) findViewById(R.id.textView);
        this.textoPost = (TextView) findViewById(R.id.textView3);
        this.textoEnviar = (TextView) findViewById(R.id.textView2);
        this.elBotonEnviar = (Button) findViewById(R.id.button);
    ...
    private void mostrarInformacionDispositivoBTLE(ScanResult resultado) {
        ...
        Log.d(ETIQUETA_LOG, " bytes (" + bytes.length + ") = " + com.example.miguelzaragozaesquerdo.ozonecontroller.Utilidades.bytesToHexString(bytes));

        com.example.miguelzaragozaesquerdo.ozonecontroller.TramaIBeacon tib = new com.example.miguelzaragozaesquerdo.ozonecontroller.TramaIBeacon(bytes);

        Log.d(ETIQUETA_LOG, " ----------------------------------------------------");
        Log.d(ETIQUETA_LOG, " prefijo  = " + com.example.miguelzaragozaesquerdo.ozonecontroller.Utilidades.bytesToHexString(tib.getPrefijo()));
        ...
        this.textoEnviar.setText(String.valueOf(Utilidades.bytesToInt(tib.getMajor())));
    ...
    public void botonBuscarNuestroDispositivoBTLEPulsado(View v) {
        ...
        this.buscarEsteDispositivoBTLE("P_Biometria_1");
...
public void botonEnviarDato(View quien){
    ...
    elPeticionario.hacerPeticionREST("POST", "http://192.168.1.47:3001/api/sensor/value/",
            ...
            new PeticionarioREST.RespuestaREST () {
                @Override
                public void callback(int codigo, String cuerpo) {
                    textoPost.setText ("codigo respuesta= " + codigo + " <-> \n" + cuerpo);
                }
            });
}
